#!/usr/bin/env python3
"""Bonferroni-corrected paired bootstrap suite for Direction-1.
...
Inputs (must already exist):
  * ``analysis/direction1/results/per_checkpoint_cfr.parquet``
  * ``analysis/direction1/results/per_checkpoint_fped_fned_dixon.parquet``
  ...
  * ``analysis/direction1/results/per_checkpoint_group_ece.parquet``

Outputs:
  * ``analysis/direction1/results/significance_tests.csv``  (one row per test)
  * ``analysis/direction1/results/significance_summary.md`` (paper-ready)

Usage:
    python3 analysis/direction1/06_run_significance_suite.py
    python3 analysis/direction1/06_run_significance_suite.py --pivot cci_v2_fixed_js
"""
...
def per_seed_paired_bootstrap(
    ...
    """Two-sided paired bootstrap + exact sign test on per-seed scalar metric values.
