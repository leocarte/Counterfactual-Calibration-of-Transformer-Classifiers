#!/usr/bin/env python3
"""Assemble the unified CFR-evaluation main table (F1+ × ECE × CFR × FPED × FNED).
...
markdown table:
    ...
    analysis/results/main_table.md
...
def main():
    parser = argparse.ArgumentParser(description="Assemble CFR-evaluation main table.")
    ...
    # Build table
    lines = ["# CFR-evaluation — Main results table\n",
             "\n",
