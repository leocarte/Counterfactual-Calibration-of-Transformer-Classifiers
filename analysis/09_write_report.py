#!/usr/bin/env python3
"""Assemble CFR-evaluation REPORT.md — paper-ready summary of all artifacts.
...
This is the document to paste directly into the paper draft (or to get an
end-to-end view of the CFR-evaluation evidence).
"""
...
def main():
    parser = argparse.ArgumentParser(description="Write CFR-evaluation REPORT.md.")
    ...
    sections: list[str] = []
    sections.append(
        f"# Counterfactual flip-rate as the loss-aligned metric\n\n"
