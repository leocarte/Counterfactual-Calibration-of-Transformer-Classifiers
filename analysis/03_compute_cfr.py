...
produces ``analysis/results/per_checkpoint_metrics.parquet``
...
Usage:
    ...
    python3 analysis/03_compute_cfr.py --skip-posthoc   # only raw
"""
...
def _build_main_table_md(summary: pd.DataFrame, output_path: Path) -> None:
    ...
    lines = ["# CFR-evaluation main table — Counterfactual Flip Rate (CFR)\n",
